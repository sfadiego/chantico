    ...
    return (
        <>
            <div className="pb-1 pt-1 d-flex mb-auto border-bottom">
                ...
                <div className="p-1">${priceWithDiscount.toFixed(2)}</div>
                <Button
                    disabled={disabledActions}
                    onClick={() => handleProductDiscount(productId)}
                    className="btn btn-info btn-sm me-1 p-1 text-white"
                >
                    <i className="bi bi-percent"></i>
                </Button>
                <Button
                    disabled={disabledActions}
                    onClick={() => setProduct(productId)}
                    className="btn btn-info btn-sm p-1 text-white"
                >
