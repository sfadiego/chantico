...
export const CloseSalesForm = ({
    ...
    const { created_at, observaciones, efectivo_caja_inicio, user } =
        systemInfo;
    ...
    return (
        <div className="col-md-12 mt-2 mb-2">
            <Card>
                <CardHeader>Cerrar ventas</CardHeader>
                <CardBody>
                    <CardText>
                        Sistema abierto por{" "}
                        <b>
                        ...
                        con la fecha <b> {date}</b>
                    </CardText>
                    <CardText>
                        Efectivo inicial: $<b>{efectivo_caja_inicio}</b>
                    </CardText>
                    <CardText>Observaciones: {observaciones}</CardText>
                    <Button onClick={confirmCloseSales} variant="primary">
                        <i className="bi bi-coin"></i> Cerrar Ventas
                    </Button>
                    <NavLink
                        className={`btn btn-light ms-2`}
                        to={RoutesAdmin.Dashboard}
                        end
                    >
                        {" "}
                        Regresar
