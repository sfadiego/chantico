...
export const ProductCard = ({
    ...
    const { onSubmit } = useAddOrderProduct({
    ...
    const handleClick = async (productId: number) => {
        ...
        onSubmit(data, {
            setErrors: (errors: any) => console.log("error:", errors),
        });
    };

    return (
        <div
            className={`${classCard ? classCard : "col-lg-3 col-md-4 col-12 col-sm-6 col-xl-2 p-1"}`}
        >
