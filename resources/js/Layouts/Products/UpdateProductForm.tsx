        ...
        children: (
            <>
                <Image
                    ...
                    src={URL.createObjectURL(new Blob([picture!!]))}
                />
            </>
        ),
    };
...
export const UpdateProductForm = () => {
    ...
    if (!id) {
        navigate(AdminRoutes.ProductsPage);
    }
    ...
    const { isLoading, showData, data, refetch } = useHandleGetProduct(
        parseInt(id!!),
    );
                ...
                {({
                    ...
                    <Form>
                        ...
                        <div className="col-md-3">
                            {data?.picture ? (
                                <ComponentImageProduct data={data?.picture} />
                            ) : (
                                <div className="mb-3">
                                    <Widget
                                        cardTitle="Sin imagen"
                                        description="Imagen no asignada"
                                    />
                                </div>
                            )}
